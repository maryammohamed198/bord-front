        ...
        <form className=" col-12 h-75 my-5 ">
          ...
          >
            <div className="col-lg-6 items col-12 ">
              ...
              <div className="col-12 m-2 ">
                <label className="w-50" htmlFor="imageSrc">
                  Image Source
                </label>
                <input  style={{border:"1px solid gray" }}
                  className="w-50 btn" 
            ...
            <div className="col-12 m-2 ">
              ...
              <label className="w-50" htmlFor="category">
                Category
              </label>
              <input  style={{border:"1px solid gray" }}
                className="w-50 btn" 
            ...
            <div className="col-lg-6 items ">
              ...
              <div className="col-12 m-2 ">
                {" "}
                <label className="w-50" htmlFor="subCategory">
                  Sub Category
                </label>
                <input  style={{border:"1px solid gray" }}
                  className="w-50 btn" 
            ...
            <div className="col-lg-6 items col-12">
              <div className="col-12 m-2 ">
                {" "}
                <label className="w-50" htmlFor="typeOfProduct">
                  Type Of Product
                </label>
                <input  style={{border:"1px solid gray" }}
                  className="w-50 btn" 
            ...
            <div
              className="col-lg-6 items col-12  "
              style={{ left: "0px" }}
            >
              <div className="col-12 m-2 ">
                {" "}
              ...
              <div className="col-12 m-2 ">
                {" "}
                <label className="w-50" htmlFor="descreption">
                  Descreption
                </label>
                <input  style={{border:"1px solid gray" }}
                  className="w-50 btn" 
